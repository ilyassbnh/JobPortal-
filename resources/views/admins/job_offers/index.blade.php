<!-- resources/views/admin/job_offers/index.blade.php -->
...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('admins.job_offers.create') }}" class="btn btn-primary mb-3">Create Job Offer</a>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admins.job_offers.edit', $job_offer->id) }}" class="btn btn-warning">Edit</a>
